...
export const CaseStudies: React.FC<CaseStudiesProps> = ({ onOpenModal }) => {
  return (
    <section id="cases" className="py-24 relative bg-[#0b0f19] border-b border-slate-800">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
              Sistemas que sustentam <span className="text-blue-400">operações de alta escala</span>.
            </h2>
          </div>
              ...
              <div>
                ...
                <div className="relative h-48 w-full overflow-hidden bg-slate-950">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="px-2.5 py-0.5 rounded bg-blue-600/20 text-blue-300 border border-blue-500/30 text-[10px] font-mono font-bold">
                      {study.client}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-blue-500/20 text-[11px] text-slate-300 mb-5 flex items-start gap-2">
                    <Server className="w-3.5 h-3.5 text-blue-400 flex-shrink-0 mt-0.5" />
