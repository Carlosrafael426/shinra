        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight mb-2">
              Projetos que <span className="text-blue-400">já entreguei</span>.
            </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {CASE_STUDIES.map((study) => (
            ...
            >
              <div>
                ...
                <div className="relative h-52 w-full overflow-hidden bg-slate-950">
                  ...
                  <div className="absolute top-4 left-4 flex flex-col gap-1.5">
                    <span className="px-3 py-1 rounded-full bg-slate-950/90 border border-blue-500/30 text-[11px] font-mono text-blue-300 w-fit">
                      {study.category}
                    </span>
              ...
              {/* Bottom Action */}
              <div className="p-6 pt-0 border-t border-slate-800 mt-4 flex flex-col gap-2">
                {study.url && (
                  <a
                    href={study.url}
                    target="_blank"
                ...
                <button
                  onClick={onOpenModal}
                  className={`w-full py-2.5 rounded-xl border border-slate-700 hover:border-blue-500 bg-slate-950 hover:bg-slate-800 text-xs font-semibold text-slate-200 hover:text-blue-300 transition-all flex items-center justify-center gap-1.5 cursor-pointer ${study.url ? '' : 'mt-4'}`}
                >
