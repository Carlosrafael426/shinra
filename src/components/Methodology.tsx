      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {METHODOLOGY_STEPS.map((step, idx) => (
            <div
              key={idx}
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-blue-500/50 transition-all duration-200 flex flex-col justify-between relative group"
            >
              <div>
                {/* Step Number & Time Badge */}
                <div className="flex items-center justify-between mb-4">
                  <span className="font-mono text-3xl font-extrabold text-slate-500 group-hover:text-blue-400 transition-colors">
                    {step.step}
                  </span>
                ...
                <h3 className="font-display text-base font-bold text-white mb-1 group-hover:text-blue-300 transition-colors">
                  {step.title}
                </h3>
                <p className="text-[11px] text-blue-400 font-mono mb-3">
                  {step.subtitle}
                </p>
        ...
        <div className="mt-14 p-6 sm:p-8 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
          <div className="flex items-center gap-4">
            <div className="p-3.5 rounded-2xl bg-slate-800 border border-blue-500/30 text-blue-400">
